...
for n in range(1,len(features_list)):
    feature_n = numpy.array(finance_features)[:,n-1]
    print(features_list[n])
    print(feature_n[feature_n > 0].min())
    print(feature_n[feature_n > 0].max())
...
pred = kmeans.fit_predict(scaled_finance_features)
